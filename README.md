...
Se puede personalizar el contenido de las ciudades modificando el archivo `ciudades.js`. Cada ciudad es representada por un objeto con propiedades como `titulo`, `subtitulo`, `parrafo` y `precio`.

## Conclusiones

Se creó una aplicación de venta de viajes utilizando JavaScript. Se puede personalizar el contenido y expandir la funcionalidad de la aplicación según las necesidades planteadas. 
